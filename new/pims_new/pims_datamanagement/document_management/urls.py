...
urlpatterns = [
    ...
    path('file/<int:pk>/close/', views.FileCloseView.as_view(), name='file_close'), # New URL pattern
    path('file/<int:pk>/archive/', views.FileArchiveView.as_view(), name='file_archive'), # New URL pattern
