    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "file_number",
                    models.CharField(blank=True, help_text="Auto-generated file number.", max_length=50, unique=True),
                ),
                (
                    "file_type",
                    models.CharField(
                        choices=[("personal", "Personal"), ("policy", "Policy")], default="personal", max_length=10
                    ),
                ),
                (
                    "status",
                    models.CharField(
                        choices=[("inactive", "Inactive"), ("active", "Active"), ("closed", "Closed")],
                        default="inactive",
                        max_length=10,
                    ),
                ),
