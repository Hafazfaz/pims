...
def create_watermark_pdf(watermark_text="PIMS Confidential"):
    """
    ...
    # This example places it centrally; adjust as needed
...
def watermark_pdf_file(original_pdf_file, watermark_text="PIMS Confidential"):
    """
